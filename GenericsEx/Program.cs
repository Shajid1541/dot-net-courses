namespace GenericsEx
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Person[] arr = new Person[] { new Person { id = 2, name = "John" },
                                          new Person { id = 2, name = "Tom" },
                                          new Person { id = 2, name = "Greg" },
                                          new Person { id = 1, name = "Tom" }};
            Searching<Person> searching = new Searching<Person>();
            Console.WriteLine(searching.linearSearchMax(arr));
        }
    }
}
